  ...
  return (
        <div>
          <div className="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto">
            <div className="w-full max-w-lg bg-white dark:bg-[#121212] shadow-lg rounded-lg p-6 relative">
              <div className="my-6 text-center">
                <div className="text-5xl text-red-600">
                  <i className="fa-solid fa-trash"></i>
                </div>
                <p className="text-gray-900 text-base font-medium mt-4 dark:text-[#E0E0E0]">Are you sure you want to delete { isConfirmDelete === "confirmDeleteAllTasks" ?  "all tasks" : "task"}?</p>
